...
|---|---|---|
| `CONTINUITY.md` | `/Users/gillettes/Coding Projects/foreman/AGENTS.project.md` | AGENTS enforces Work Record and Self-audit expectations |
| `COHERENCE.md` | `/Users/gillettes/Coding Projects/foreman/AGENTS.project.md` | AGENTS enforces Ripple Check and same-commit doc updates |
| `/Users/gillettes/Coding Projects/foreman/LINEAR.md` | `/Users/gillettes/Coding Projects/foreman/AGENTS.project.md` | AGENTS gates state moves and closeout on Linear-coverage |
| `/Users/gillettes/Coding Projects/foreman/CLAUDE.md` | `CONTINUITY.md`, `COHERENCE.md`, `/Users/gillettes/Coding Projects/foreman/LINEAR.md` | Claude should load the same principle docs before planning or audit |
| `/Users/gillettes/Coding Projects/foreman/todo.md` log shapes | `CONTINUITY.md`, `/Users/gillettes/Coding Projects/foreman/LINEAR.md` | durable records and issue coverage must stay aligned with local principle docs |
| `PROJECT_INTENT.md` and local source-of-truth docs | `/Users/gillettes/Coding Projects/foreman/AGENTS.project.md`, `/Users/gillettes/Coding Projects/foreman/CLAUDE.md` | task routing and authority statements depend on the docs map remaining accurate |
...
- `/Users/gillettes/Coding Projects/foreman/AGENTS.project.md`
- `/Users/gillettes/Coding Projects/foreman/CLAUDE.md`
- `/Users/gillettes/Coding Projects/foreman/LINEAR.md`
- `/Users/gillettes/Coding Projects/foreman/todo.md`
