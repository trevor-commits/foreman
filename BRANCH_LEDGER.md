...
|--------|-------|------|------|-----------------|--------|--------|-------|
| `agent/codex/2026-08-15/branch-cleanup` | codex-gpt-5.6-sol | 2026-08-15 | Merge every non-default branch into `main`, preserve dirty work, and remove merged branches and releasable worktrees | closeout record merged, then this final branch deleted | `01a00813-4314-76d0-8dea-2ca70f2126fb` | ready | PR #4 merged at `5f9a488`. Source branches and linked worktrees removed. Recovery refs retained. |
...
|--------|-------|------|------|---------|--------|
| `agent/claude/2026-07-30/agents-first-consolidation` | claude | 2026-07-30 | Consolidate the agent-first governance changes | PR #3 squash merge verified against exact source head `6cf1425`. Local and remote branches deleted after archive and bundle protection. | 2026-08-15 |
| `codex/er930-opus5-only` | codex-gpt-5.6 | 2026-08-11 | Enforce exact Claude Opus 5 selectors and fail closed on earlier Claude models | Source work committed as `d38c5be` and integrated through PR #4. The broker consumed the released lease, removed the worktree, and retained an archive tag. | 2026-08-15 |
